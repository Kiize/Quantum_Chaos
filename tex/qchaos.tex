...
Let us consider a Bunimovich stadium, where the rectangle has length $L_x = 1, L_y = 2$. Consider, using our previous notation, different values $M = N^2 \in {1600, 2500, 3600, 4900}$, then solving the problem for the first $k = 0.8M$ eigenvalues
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{../figs/hist_ene_stadium_N2450.png}
